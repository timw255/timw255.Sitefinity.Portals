...
namespace timw255.Sitefinity.Portals.Data.EntityFramework.Decorators
{
    public class UserDashboardsEFDataProviderDecorator : IDataProviderDecorator, IExecutionStateDecorator
    {
        ...
        {
            var provider = (IUserDashboardsEFDataProvider)this.DataProvider;
        ...
        {
            var dataProvider = (IUserDashboardsEFDataProvider)this.DataProvider;
